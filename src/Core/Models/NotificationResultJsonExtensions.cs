...
/// <summary>
/// Provides JSON serialization extensions for <see cref="NotificationResult"/> objects
/// </summary>
public static class NotificationResultJsonExtensions
{
    ...
    public static NotificationResult? FromJson(string json)
    {
        ...
        return JsonSerializer.Deserialize<NotificationResult>(json, _jsonOptions);
    }
