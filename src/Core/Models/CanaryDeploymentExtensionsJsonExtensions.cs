...
public static class CanaryDeploymentExtensionsJsonExtensions
{
	...
	/// <summary>
	/// Deserializes JSON string to <see cref="CanaryDeploymentExtensionsMetadata"/>.
	/// </summary>
	/// <param name="json">JSON string to deserialize.</param>
	/// <returns><see cref="CanaryDeploymentExtensionsMetadata"/> instance or null if deserialization fails.</returns>
	...
	/// <summary>
	/// Attempts to deserialize JSON string to <see cref="CanaryDeploymentExtensionsMetadata"/>.
	/// </summary>
	/// <param name="json">JSON string to deserialize.</param>
	...
	/// <exception cref="ArgumentNullException">Thrown when <paramref name="json"/> is null.</exception>
	public static bool TryFromJson(string json, [NotNullWhen(true)] out CanaryDeploymentExtensionsMetadata? value)
	{
		ArgumentNullException.ThrowIfNull(json);
	...
	/// <summary>
	/// Metadata representation of the <see cref="CanaryDeploymentExtensions"/> class for JSON serialization.
	/// </summary>
