...
public static class WebhookPayloadValidation
{
	...
	/// <returns><see langword="true"/> if the input is a valid GUID format; otherwise, <see langword="false"/>.</returns>
	...
	/// </summary>
	/// <param name="input">The string to validate.</param>
	/// <returns><see langword="true"/> if the input is a valid semantic version; otherwise, <see langword="false"/>.</returns>
...
public static class WebhookDataValidation
{
	...
	/// <returns><see langword="true"/> if the status is valid; otherwise, <see langword="false"/>.</returns>
	...
	/// </summary>
	/// <param name="environment">The environment name to validate.</param>
	...
	/// <returns><see langword="true"/> if the branch is valid; otherwise, <see langword="false"/>.</returns>
	...
	/// </summary>
	/// <param name="commitHash">The commit hash to validate.</param>
	/// <returns><see langword="true"/> if the commit hash is valid; otherwise, <see langword="false"/>.</returns>
