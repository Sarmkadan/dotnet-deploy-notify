...
/// <summary>
/// Provides JSON serialization extensions for <see cref="ChannelConfiguration"/>.
/// </summary>
public static class ChannelConfigurationJsonExtensions
{
    ...
    /// <summary>
    /// Serializes the <see cref="ChannelConfiguration"/> to a JSON string.
    /// </summary>
    ...
    public static string ToJson(this ChannelConfiguration value, bool indented = false)
    {
    ...
    /// <summary>
    /// Deserializes a JSON string to a <see cref="ChannelConfiguration"/> instance.
    /// </summary>
    ...
    public static bool TryFromJson(string json, out ChannelConfiguration? value)
    {
        ...
        try
        {
            value = JsonSerializer.Deserialize<ChannelConfiguration>(json, _jsonOptions);
            return true;
        }
        catch (JsonException)
        {
