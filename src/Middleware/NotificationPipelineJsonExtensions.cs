...
/// <summary>
/// Provides System.Text.Json serialization extensions for NotificationPipeline and related types
/// </summary>
public static class NotificationPipelineJsonExtensions
{
    ...
    /// <summary>
    /// Converts a NotificationPipeline to a JSON string
    /// </summary>
    ...
    /// <summary>
    /// Parses a JSON string into a NotificationPipeline instance
    /// </summary>
    /// <param name="json">The JSON string to parse</param>
    /// <returns>The deserialized NotificationPipeline, or null if parsing fails</returns>
    ...
    /// <summary>
    /// Attempts to parse a JSON string into a NotificationPipeline instance
    /// </summary>
    /// <param name="json">The JSON string to parse</param>
    /// <param name="value">Receives the deserialized NotificationPipeline if successful</param>
