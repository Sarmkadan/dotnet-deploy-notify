...
public static class NotificationProcessorTestsExtensions
{
	...
	{
		ArgumentOutOfRangeException.ThrowIfNegative(totalProcessed);
	...
	{
		ArgumentOutOfRangeException.ThrowIfNegative(totalNotifications);
		ArgumentOutOfRangeException.ThrowIfNegative(pendingCount);
		ArgumentOutOfRangeException.ThrowIfNegative(processedCount);
		ArgumentOutOfRangeException.ThrowIfNegative(successfulDeliveries);
		ArgumentOutOfRangeException.ThrowIfNegative(failedDeliveries);
		ArgumentOutOfRangeException.ThrowIfNegative(totalDeliveryAttempts);
		ArgumentOutOfRangeException.ThrowIfNegative(averageDeliveryTimeMs);
	...
	/// <exception cref="ArgumentOutOfRangeException">Thrown when durationMs is negative or attemptNumber is not positive.</exception>
		...
		int attemptNumber = 1)
	{
		...
		ArgumentOutOfRangeException.ThrowIfLessThan(httpStatusCode, 100);
		ArgumentOutOfRangeException.ThrowIfGreaterThan(httpStatusCode, 599);
